...
<html>
	...
	echo"<table class='table' border=7 cellspacing=7 cellpading=7 align=center>";
		echo"<caption><H3>List of Leave Requests</H3> </caption>";		
		echo"<tr><th>Employee<th>Leave Type <th>Description<th>Requested Date<th>Leave Date<th>Number of days<th>Accept<th>Deny</tr>";
	...
	$query="select * from users where uid='$emp_id'";
...
while($row1=mysql_fetch_array($result1))
	...
	$username=$row1['username'];
		 ...
		 echo "<tr><span id=venue2><th>". $row1['username'],"<th>",$row['Leave_type'],"<th>",$row['Leave_type_description'],"<th>",$row['Request_date'],
				"<th>",$row['leave_date'],"<th>",$row['num'],"<th>",
				"<a href='accept.php?id=$row[Leave_type_id]'>Accept</a>","<th>",
				"<a href='deny.php?id=$row[Leave_type_id]'>Deny</a>",
				"</tr>";
		}
}?>
