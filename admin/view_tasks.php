...
<html>
	...
	echo"<table class='table' >";
		echo"<caption><H3>List of Projects On Process...</H3> </caption>";		
		echo"<tr><th>Name of Project <th>Start<th>End</tr>";
	...
	$end_date=$row['end_date'];
		 ...
		 echo "<tr><span id=venue2><th>". $row['name'],"<th>",$row['start_date'],"<th>",$row['end_date'],
				"<th>",
				"<a href='task_detail.php?id=$row[id]'>detail</a>","<th>",
				//check for foreign Key...same employee can assign to same project multiple...duplication...
				"<a href='task_remove.php?id1=$row[id]'>Remove</a>",
				"</tr>";
