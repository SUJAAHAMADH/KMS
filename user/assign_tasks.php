...
<div id="wrapper">
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
		  ...
		  <h3 class="text-center">Projects you are working currently....</h3>
		    <table class="table">
		      <thead>
		        <tr>
		          <th>#</th>
 ...
 <?php
	...
	//$_SESSION['id1']=$id;	
		 ...
		 echo "<tr><span id=venue2><th>","<th>",$row['pro_name'],"<th>",
				$row['date_add'],"&emsp;&emsp;<a href='view_detail_task.php?id1=$row[task_id]'>Detail view</a>",
