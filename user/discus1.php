...
//echo $id; 
	...
	$query="select * from message where (sender='$sender' and reciever='$reciever') OR (sender='$reciever' and reciever='$sender') and reciever_read='yes' ORDER BY date_send ASC";
	...
	//$num_rows = mysql_num_rows($result1);
		...
		echo "";
		echo "<input type='checkbox' class='checkbox'><div style='color:blue;'>".$row1['sender'].":</div><br/> ".$row1['mesg']."&emsp;&emsp;<label  >".$row1['date_send']."</label>&emsp;&emsp;<a href='delete2.php?id1=$row[id]' class='font-red' > <i class='fa fa-times' icon_9=''></i>Delete</a></div><br/>";
