...
<div id="wrapper">
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
		  ...
		  <h3 class="text-center">Upload Project details</h3>
		  
		  <!--sdnsj-->
		
<div class="tab-pane active" id="horizontal-form">
							<form   class="form-horizontal"   action="finished_pro.php" method="POST"  role="form" autocomplete="off"  enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Title</label>
									<div class="col-sm-8">
										<input type="text" name="title" class="form-control1" id="focusedinput" placeholder="title" required autofocus>
									</div>
								...
								<div class="form-group">
										<label for="txtarea1" class="col-sm-2 control-label">Select Group Members </label>
										<div class="col-sm-8">
									 <?php
...
echo "<select name='user_name1' value=''class='form-control1'>--select member1--</option>"; // list box select command
...
echo "<select name='user_name2' value=''class='form-control1'>--select member2--</option>"; // list box select command
echo "<option value=''>---select member2---</option>";
while($row2=mysql_fetch_array($result))
{
//$id=$row2['id'];
echo "<option value='".$row2['username']."'>".$row2['username']."</option>";
...
echo "<select name='user_name3' value=''class='form-control1'>--select member3--</option>"; // list box select command
echo "<option value=''>---select member3---</option>";
while($row2=mysql_fetch_array($result))
{
//$id=$row2['id'];
echo "<option value='".$row2['username']."'>".$row2['username']."</option>";
...
echo "<select name='user_name4' value=''class='form-control1'>--select member4--</option>"; // list box select command
echo "<option value=''>---select member4---</option>";
while($row2=mysql_fetch_array($result))
{
//$id=$row2['id'];
echo "<option value='".$row2['username']."'>".$row2['username']."</option>";
...
echo "<select name='user_name5' value=''class='form-control1'>--select member5--</option>"; // list box select command
echo "<option value=''>---select member5---</option>";
while($row2=mysql_fetch_array($result))
{
//$id=$row2['id'];
echo "<option value='".$row2['username']."'>".$row2['username']."</option>";
...
?>
								      ...
								      <div class="form-group">
										...
										<div class="col-sm-8">
										<input type="file" name="learn" class="form-control1" id="exampleInputFile" required autofocus>
										<p class="help-block">upload your Project materials here.</p>
										</div>
									</div>
	...
	$user_name4=$_POST['user_name4'];
	$user_name5=$_POST['user_name5'];
	$user=	$_SESSION['user'];
	//$txtarea1=	$_POST['txtarea1'];

	$comb=$user_name1.",".$user_name2.",".$user_name3.",".$user_name4.",".$user_name5;
	//$image=$_POST['image'];
	
	
	
	
	move_uploaded_file($_FILES['learn']['tmp_name'],'upload_learn/'.$_FILES['learn']['name']);
    $learn=mysql_real_escape_string($_FILES["learn"]["name"]);
...
$query="insert into project(title,category,members,pro_file,date_add)
		values('$title','$selector1','$comb','$learn','$date1')";
