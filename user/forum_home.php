...
<div id="wrapper">
 ...
 <?php
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from post_topic where category='Computer Science & Technology'";
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from post_topic where category='Management'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from post_topic where category='Architecture'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
	...
	$num_rows = mysql_num_rows($result1);
		 ...
		 echo "<tr><span id=venue2><th>","<th>",$row['title'],"<th>","$num_rows",
		    ...
		    <div class="bs-example1" data-example-id="contextual-table">
		  <h3 class="text-center">Question & Answers</h3>
		    <table class="table">
		      <thead>
		        <tr>
		          <th>#</th>
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from post_topic where category='Question & Answers'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from post_topic where category='Others'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
