...
<div id="wrapper">
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
		  ...
		  <h3 class="text-center">List of Active Members</h3>
	...
	echo"<table class='table' >";
		...
		echo" <tr style='background-color:#98FB98;'><th>Profile Image<th>Name<th>Email Address<th>Contact No</tr>";
	...
	$image=$row['pro_image'];
		 ...
		 echo " <tr><span id=venue2><th>". "<img src='../uploadimages/".$row['pro_image']."'width=60px height=40px/>","<th>",$row['username'],"<th>",$row['email'],"<th>",$row['contactno'],
				"<th>",
