...
<div id="wrapper">
 ...
 <?php
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from message where reciever='$user1' and reciever_read='no' GROUP BY sender";
	...
	//$_SESSION['id1']=$id;	
		 ...
		 echo "<tr><span id=venue2><th>"," <input type='checkbox' class='checkbox'><th>",$row['sender'],"<th>",$row['date_send'],
				"<th>","<a href='inbox_logic.php?id1=$row[id]'>view</a>","&emsp;<a href='delete2.php?id2=$row[sender]' class='font-red' title=''> <i class='fa fa-times' icon_9=''></i>Delete</a>",
	   ...
	   <br/>
	    ...
	    <div class="bs-example1" data-example-id="contextual-table">
		  <h3 class="text-center">Read Messages</h3>
		    <table class="table">
		      <thead>
		        <tr>
		          <th>#</th>
 ...
 <?php
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from message where (reciever='$user1') and reciever_read='yes' and sender_read='yes'  GROUP BY sender";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
	...
	//$_SESSION['id1']=$id;	
		 ...
		 echo "<tr><span id=venue2><th>"," <input type='checkbox' class='checkbox'><th>",$row['sender'],"<th>",$row['date_send'],
				"<th>","<a href='discus1.php?id1=$row[id]'>view</a>","&emsp; <a href='delete3.php?id3=$row[id]' class='font-red' title=''> <i class='fa fa-times' icon_9=''></i>Delete</a>",
