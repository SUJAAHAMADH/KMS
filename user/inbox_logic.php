...
session_start();
 $user=	$_SESSION['user'];
	...
	$query="UPDATE message SET sender_read='yes',reciever_read='yes' where id='$id'";
...
//echo $id; 
	...
	$query="select * from message where sender='$sender' and reciever='$reciever' ORDER BY date_send ASC";
	...
	//$num_rows = mysql_num_rows($result1);
		...
		echo "<div style='color:blue;'>".$row1['sender'].":</div><br/> ".$row1['mesg']."&emsp;&emsp;<label  >".$row1['date_send']."</label></div><br/>";
	...
	?>
		  ...
		  <h3 class="text-center">Reply</h3>
		   ...
		   <form   class="form-horizontal"   action="discus.php" method="POST"  role="form" autocomplete="off">
