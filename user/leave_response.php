...
<div id="wrapper">
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
		  ...
		  <h3 class="text-center">Leave Responses....</h3>
		    <table class="table">
		      <thead>
		        <tr>
		          <th>Leave Type</th>
 ...
 <?php
	...
	$query="select * from leave_status where emp_id='$id1'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
	...
	//$_SESSION['id1']=$id;	
		 ...
		 echo "<tr><span id=venue2><th>",$row['Leave_type'],"<th>",$row['Request_date'],"<th>",
				$row['leave_date'],"<th>",$row['num'],"<th>",$row['status'],
