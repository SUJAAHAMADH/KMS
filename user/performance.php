...
session_start();
 $user=	$_SESSION['user'];
	...
	$sql="select * from assigned_tasks where emp_name='$user' and status='yes'";
...
$tot=(int)$_SESSION['tot'];

	$chart = new VerticalBarChart();
//$result=($total-$num1);
	$serie1 = new XYDataSet();
	$serie1->addPoint(new Point("PS",$num_rows2));
	
	$serie2 = new XYDataSet();
	$serie2->addPoint(new Point("PS",$tot));
	
	
	$dataSet = new XYSeriesDataSet();
	$dataSet->addSerie("Total points", $serie1);
	$dataSet->addSerie("Performed points", $serie2);
	$chart->setDataSet($dataSet);
	$chart->getPlot()->setGraphCaptionRatio(0.5);

	$chart->setTitle("Performance Report");
...
<div id="wrapper">
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
		...
		<h3 class="text-center">Performance Report </h3>
