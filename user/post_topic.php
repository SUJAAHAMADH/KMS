...
<div id="wrapper">
     	...
     	<div class="col_3">
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                     <a href="forum_home.php"> <i class="pull-left fa fa-thumbs-up icon-rounded"></i></a>
                    <div class="stats">
                      <h5><strong></strong></h5>
                      <span>Forum</span>
                    </div>
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
		  ...
		  <h3 class="text-center">Post topics to Forum</h3>
		  
		  <!--sdnsj-->
		
<div class="tab-pane active" id="horizontal-form">
							<form   class="form-horizontal"   action="post_topic.php" method="POST"  role="form" autocomplete="off">
								<div class="form-group">
									...
									<div class="col-sm-2">
										<p class="help-block">Enter understandable title!</p>
									</div>
								</div>
								...
								<div class="form-group">
									<label for="txtarea1"   class="col-sm-2 control-label">Write post</label>
	...
	$query="insert into post_topic(title,message,category,user_name,time_post)
		values('$title','$txtarea1','$selector1','$user','$dat')";
