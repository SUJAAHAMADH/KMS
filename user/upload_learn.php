...
<div id="wrapper">
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
		  ...
		  <h3 class="text-center">Upload Learning Materials</h3>
		  
		  <!--sdnsj-->
		
<div class="tab-pane active" id="horizontal-form">
							<form   class="form-horizontal"   action="upload_learn.php" method="POST"  role="form" autocomplete="off"  enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8"><select name="selector1" id="selector1" class="form-control1">
								      ...
								      <div class="form-group">
										...
										<p class="help-block">upload your learnig materials here.</p>
										</div>
									</div>
...
$query="insert into learn_material(category,file_loca,date_upload,title,upload_by)
		values('$selector1','$learn','$date1','$title','$user')";
