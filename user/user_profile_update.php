	...
	<!--end profile-->	 
	 ...
	 <div class="container">
			...
			<div class="row well" style=" background-color:#98FB98;">
			 <form class="col-md-8"  action="profile_update_logic.php" method="POST" role="form" enctype="multipart/form-data">
				<label style="color:blue;font-size:150%;  font-family: verdana;" > Name</label> <input  style=" background-color:yellow;font-weight: bold;" type="text" readonly name="name" class="form-control"  value="<?php echo $_SESSION['name'];?>"  required autofocus><br/>
                                  <label style="color:blue;font-size:150%;  font-family: verdana;" > Email</label><input  style="font-weight: bold;" type="text"  name="email" class="form-control"  value="<?php echo $_SESSION['email'];?>" required><br/>
								   <label style="color:blue;font-size:150%;  font-family: verdana;" >NIC</label><input style="font-weight: bold;" type="text"   name="nic" class="form-control"  value="<?php echo $_SESSION['nic'];?>"required autofocus><br/>
								   <label style="color:blue;font-size:150%;  font-family: verdana;" >Phone</label><input style="font-weight: bold;" type="text"  name="phone"  class="form-control"  value="<?php echo $_SESSION['phone'];?>"  required autofocus><br/>
                                  <label style="color:blue;font-size:150%;  font-family: verdana;" >Job Category</label><input style="font-weight: bold;" type="text"  name="job"  class="form-control"  value="<?php echo $_SESSION['role'];?>"  required autofocus><br/>
								  <label style="color:blue;font-size:150%;  font-family: verdana;" >Set a New Password</label><input style="font-weight: bold;" type="password"  name="pass"  class="form-control"   required autofocus><br/>
								<label style="color:blue;font-size:150%;  font-family: verdana;">  Upload New profile photo</label><input type="file" style="font-weight: bold;" name="image" class="form-control" placeholder="Upload image"  required><br/>
