...
<div id="wrapper">
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
		  ...
		  <h3 class="text-center">Detail View about the project....</h3>
		    <table class="table">
		      <thead>
		        <tr>
		          <th>#</th>
 ...
 <?php
	...
	$query="select * from assigned_tasks where emp_name='$user1' and status='no'";
	...
	//$_SESSION['id1']=$id;	
		 ...
		 echo "<tr><span id=venue2><th>","<th style='color:green;'>",$row['pro_name'],"<th style='color:green;'>",
				$row['date_add'],"<th style='color:green;'>",$row['estimated'],
 ...
 <?php
	...
	//$_SESSION['id1']=$id;	
		 ...
		 echo "<tr><span id=venue2><th>","<th style='color:green;'>",$row['emp_name'],"<th style='color:green;'>",
				$row['date_add'],
		...
		<h5 class="text-center">Commit if you finish your task by commiting the task below...</h5>
		 <form   class="form-horizontal"   action="commit.php" method="POST"  role="form" autocomplete="off">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Select no of days to finish</label>
									<div class="col-sm-8">
							...
							<div class="form-group">
									...
									<div >
								 <button class="btn btn-success" type="submit" name="submit">commit</button>
