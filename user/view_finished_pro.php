...
<div id="wrapper">
 ...
 <?php
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from project where category='Computer Science & Technology'";
	...
	//$_SESSION['id1']=$id;	
		 ...
		 echo "<tr><span id=venue2><th>","<th>",$row['title'],"<th>","<a href='http://localhost/KMS/user/upload_learn/",$pro_file,"'>",$pro_file,"</a>","<th>",$row['members'],
				"<th>",$row['date_add'],
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from project where category='Management'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from project where category='Architecture'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
