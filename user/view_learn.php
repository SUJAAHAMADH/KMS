...
<div id="wrapper">
 ...
 <?php
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from learn_material where category='Computer Science & Technology'";
	...
	//$_SESSION['id1']=$id;	
		 ...
		 echo "<tr><span id=venue2><th>","<th>",$row['title'],"<th>","<a href='http://localhost/KMS/user/upload_learn/",$file_loca,"'>",$file_loca,"</a>","<th>",$row['upload_by'],
				"<th>",$row['date_upload'],
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from learn_material where category='Management'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from learn_material where category='Architecture'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
	...
	include "../db.php";
	$user1=	$_SESSION['user'];
	$query="select * from learn_material where category='Others'";
	$result=mysql_query($query) or die("query failed <br><b>".mysql_error);	
