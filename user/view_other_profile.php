...
<div id="wrapper">
	...
	echo"<table class='table table-bordered' >";
		echo"<caption><H3>List of Profile</H3> </caption>";		
		echo"<tr><th>Name <th>Email<th>Contact No<th>NIC<th>Job<th>Profile Image</tr>";
	...
	$image=$row['pro_image'];
		 ...
		 echo "<tr><span id=venue2><th>". $row['username'],"<th>",$row['email'],"<th>",$row['contactno'],
				"<th>",$row['NIC'],"<th>",$row['role'],"<th>","<img src='../uploadimages/".$row['pro_image']."'width=60px height=40px/>","<th>",
